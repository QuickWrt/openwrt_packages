...
wget https://github.com/sbwml/openwrt_helloworld/blob/v5/patch-luci-app-passwall.patch
wget https://github.com/sbwml/openwrt_helloworld/blob/v5/patch-luci-app-ssr-plus.patch
